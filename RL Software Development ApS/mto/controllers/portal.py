...
class ShipmentPortal(portal.CustomerPortal):
    ...
    def portal_my_shipments(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, search=None, search_in='all', groupby=None, **kw):
        ...
        searchbar_sortings = self._get_searchbar_sortings_mto_ic()
        searchbar_inputs = self._get_searchbar_inputs_mto_ic()
        searchbar_groupby = self._get_searchbar_groupby_mto_ic()
...
#             groupby = 'none'
        ...
        if search and search_in:
            domain += self._get_search_domain_mto_ic(search_in, search)
...
#         groupby_mapping = self._get_groupby_mapping_mto_ic()
...
#             'groupby': groupby,
    ...
    @http.route(['/my/shipments/<int:order_id>'], type='http', auth="user", website=True)
    ...
    def _get_searchbar_sortings_mto_ic(self):
    ...
    def _get_searchbar_groupby_mto_ic(self):
    ...
    def _get_groupby_mapping_mto_ic(self):
    ...
    def _get_searchbar_inputs_mto_ic(self):
    ...
    def _get_search_domain_mto_ic(self, search_in, search):
        search_domain = []
