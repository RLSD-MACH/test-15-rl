...
odoo.define('website_sale_searchbar.s_searchbar', function (require) {
    'use strict';
   ...
   publicWidget.registry.searchBar = publicWidget.Widget.extend({
        ...
        start: function () {
            ...
            this.options = {
                ...
                'displayDefault_code': this.displayDefault_code,
                'displayBarcode': this.displayBarcode,
                'displayCustomer_art_no': this.displayCustomer_art_no,
    ...
    ajax.loadXML('/website_sale_searchbar/static/src/snippets/s_searchbar/000.xml', qweb);
    });