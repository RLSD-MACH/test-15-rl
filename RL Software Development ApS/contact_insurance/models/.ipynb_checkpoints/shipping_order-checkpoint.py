...
class ShippingOrder(models.Model):
    ...
    origin_id = fields.Many2one("stock.location", string='Origin', ondelete='restrict', required=False, domain="[('usage', '=', 'internal')]")
    destination_id = fields.Many2one("stock.location", string='Destination', ondelete='restrict', required=False, domain="[('usage', '=', 'internal')]")
    ...
    volume_cubic_meter = fields.Float(related='container_id.volume_cubic_meter')
