odoo.define('website_sale_searchbar.s_products_searchbar', function (require) {
    'use strict';
    ...
    publicWidget.registry.productsSearchBar = publicWidget.Widget.extend({
        ...
        xmlDependencies: ['/website_sale_searchbar/static/src/xml/website_sale_utils.xml'],
        events: {
        ...
        start: function () {
            ...
            this.displayDefault_code = !!this.$input.data('displayDefault_code');
            this.displayBarcode = !!this.$input.data('displayBarcode');
            this.displayCustomer_art_no = !!this.$input.data('displayCustomer_art_no');
            ...
            return this._rpc({
                ...
                params: {
                    ...
                    'options': {
                        ...
                        'display_default_code': this.displayDefault_code,
                        'display_barcode': this.displayBarcode,
                        'display_customer_art_no': this.displayCustomer_art_no,
        ...
        _render: function (res) {
            ...
            if (res) {
                ...
                this.$menu = $(qweb.render('website_sale_searchbar.productsSearchBar.autocomplete', {
                    products: products,
