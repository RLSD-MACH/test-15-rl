...
class MtoIcOrder(models.Model):
    ...
    all_purchased = fields.Boolean(required=False, string='All purchased', compute="_compute_all_purchased")
    all_on_so = fields.Boolean(required=False, string='All on SO', compute="_compute_on_so")
