odoo.define('ms_form_recognizer.upload.file.mixin', function (require) {
"use strict";
    ...
    var UploadFileMixin = {
        ...
        start: function () {
            ...
            this.fileUploadID = _.uniqueId('ms_form_recognizer_file_upload');
        ...
        _onFileUploaded: function () {
            ...
            return this._rpc({
                model: 'danloen.bookkeeping.employee',
                method: 'create_from_attachment',
                args: ["", attachent_ids],
        ...
        _onUpload: function (event) {
            ...
            if (!$formContainer.length) {
                $formContainer = $(qweb.render('ms_form_recognizer.FilesHiddenUploadForm', {widget: this}));
    ...
    return UploadFileMixin;
});


odoo.define('ms_form_recognizer.files.tree', function (require) {
"use strict";
    var core = require('web.core');
    var ListController = require('web.ListController');
    var ListView = require('web.ListView');
    var UploadFileMixin = require('ms_form_recognizer.upload.file.mixin');
    var viewRegistry = require('web.view_registry');

    var FilesListController = ListController.extend(UploadFileMixin, {
        buttons_template: 'FilesListView.buttons',
    ...
    var FilesListView = ListView.extend({
        config: _.extend({}, ListView.prototype.config, {
            Controller: FilesListController,
        }),
    });

    viewRegistry.add('danloen_tree', FilesListView);
});
